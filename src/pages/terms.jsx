		...
		<Page title={title}>
			...
			<ol type="a">
				...
				<li>
					...
					any of these restrictions and may be terminated by LRNZ09
			...
			<ol type="a">
				<li>
					The materials on LRNZ09's website are provided on an 'as
					is' basis. LRNZ09 makes no warranties, expressed or
				...
				<li>
					Further, LRNZ09 does not warrant or make any
			...
			<p>
				...
				the use or inability to use the materials on LRNZ09's website,
				even if LRNZ09 or a LRNZ09 authorized representative has been
			...
			<p>
				...
				LRNZ09 of the site. Use of any such linked website is at the
				user's own risk.
			</p>
