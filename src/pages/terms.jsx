    ...
    <>
        ...
        <Page>
            ...
            <p>
                ...
                <a href="https://lorenzopieri.dev">https://lorenzopieri.dev</a>,
            ...
            <ol type="a">
                <li>
                    ...
                    the materials (information or software) on LRNZ09's website
                    ...
                    <ol type="i">
                        ...
                        <li>
                            ...
                            software contained on LRNZ09's website;
                        </li>
                        <li>
                ...
                <li>
                    ...
                    any of these restrictions and may be terminated by LRNZ09 at
            ...
            <ol type="a">
                <li>
                    The materials on LRNZ09's website are provided on an 'as is'
                    basis. LRNZ09 makes no warranties, expressed or implied, and
                ...
                <li>
                    Further, LRNZ09 does not warrant or make any representations
            ...
            <h3>4. Limitations</h3>
            <p>
                In no event shall LRNZ09 or its suppliers be liable for any
                damages (including, without limitation, damages for loss of data
                or profit, or due to business interruption) arising out of the
                use or inability to use the materials on LRNZ09's website, even
                if LRNZ09 or a LRNZ09 authorized representative has been
            ...
            <p>
                The materials appearing on LRNZ09's website could include
                technical, typographical, or photographic errors. LRNZ09 does
                not warrant that any of the materials on its website are
                accurate, complete or current. LRNZ09 may make changes to the
                materials contained on its website at any time without notice.
                However LRNZ09 does not make any commitment to update the
                materials.
            </p>
            <h3>6. Links</h3>
            <p>
                LRNZ09 has not reviewed all of the sites linked to its website
                and is not responsible for the contents of any such linked site.
                The inclusion of any link does not imply endorsement by LRNZ09
                of the site. Use of any such linked website is at the user's own
                risk.
            </p>
            <h3>7. Modifications</h3>
            <p>
                LRNZ09 may revise these terms of service for its website at any
            ...
            <p>
                ...
                accordance with the laws of Italy and you irrevocably submit to
